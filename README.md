...
> <b>ɴᴇᴡ:</b> ᴀʟʟ ᴘʀᴏᴍᴏ ᴀɴᴅ ғᴏʀᴡᴀʀᴅ-ᴄᴏɴғɪɢ ᴄᴏᴍᴍᴀɴᴅs ᴀʀᴇ ɢᴏɴᴇ — ᴇᴠᴇʀʏᴛʜɪɴɢ ɪs ɴᴏᴡ ᴅᴏɴᴇ ᴛʜʀᴏᴜɢʜ ᴛʜᴇ <code>/settings</code> ʙᴜᴛᴛᴏɴ ᴘᴀɴᴇʟ.
...
- <b>ᴘᴇʀ-ᴜsᴇʀ sᴏᴜʀᴄᴇ & ᴅᴇsᴛɪɴᴀᴛɪᴏɴ — ᴄᴏɴғɪɢᴜʀᴇᴅ ғʀᴏᴍ <code>/settings</code></b>
...
- <b>ᴀʟʟ ᴛᴇʟᴇɢʀᴀᴍ ғᴏʀᴍᴀᴛᴛɪɴɢ ᴇɴᴛɪᴛɪᴇs ᴀʀᴇ ᴘʀᴇsᴇʀᴠᴇᴅ — <i>ᴄʟɪᴄᴋᴀʙʟᴇ ʟɪɴᴋs ɪɴsɪᴅᴇ ᴛᴇxᴛ, ʙᴏʟᴅ, ɪᴛᴀʟɪᴄ, sᴘᴏɪʟᴇʀ, ᴄᴏᴅᴇ ᴇᴛᴄ.</i></b>
...
### sᴇᴛᴛɪɴɢs ᴘᴀɴᴇʟ <b>(ᴛʜᴇ ᴏɴᴇ ᴀɴᴅ ᴏɴʟʏ ᴜɪ)</b>

- <b>ᴏᴘᴇɴ ᴡɪᴛʜ <code>/settings</code> ᴏʀ ᴛʜᴇ <code>⚙ sᴇᴛᴛɪɴɢs</code> ʙᴜᴛᴛᴏɴ ᴏɴ <code>/start</code>.</b>
- <b>ᴀ sɪɴɢʟᴇ ᴘʜᴏᴛᴏ + ᴄᴀᴘᴛɪᴏɴ + ɪɴʟɪɴᴇ-ʙᴜᴛᴛᴏɴ ᴍᴇssᴀɢᴇ.</b>
...
└── plugins/
    ...
    ├── logins.py        # /login, /cancel + button-driven login flow
    ├── settings.py      # /settings — GUI panel: promos + forward config + logout
    ...
    └── promo.py         # promo helpers + per-promo asyncio scheduler (driven by /settings)
```
...
- <b>ᴄᴏᴍᴍᴀɴᴅs</b> — <b>ᴏᴘᴇɴs ᴀ sᴜʙ-ᴍᴇɴᴜ ᴡɪᴛʜ ᴛᴡᴏ ʙᴜᴛᴛᴏɴs:</b>
  ...
  - <b>ғᴏʀᴡᴀʀᴅ</b> — <b>sʜᴏᴡs ᴀʟʟ ʟᴏɢɪɴ + <code>/settings</code> + ғᴏʀᴡᴀʀᴅ ɪɴsᴛʀᴜᴄᴛɪᴏɴs (ᴇɴɢʟɪsʜ)</b>
- <b>ᴏᴡɴᴇʀ</b> — <b>ʟɪɴᴋ ᴛᴏ ᴛʜᴇ ᴏᴡɴᴇʀ's ᴛᴇʟᴇɢʀᴀᴍ ᴘʀᴏғɪʟᴇ</b>

## ᴄᴏᴍᴍᴀɴᴅs

> <b>ᴀʟʟ ᴘʀᴏᴍᴏ ᴄᴏᴍᴍᴀɴᴅs (<code>/setp</code>, <code>/list</code>, <code>/ptime</code>, <code>/promoon</code>, <code>/promooff</code>, <code>/promonow</code>, <code>/editpromo</code>, <code>/promopreview</code>, <code>/promostatus</code>, <code>/delpromo</code>, <code>/cancelp</code>) ᴀɴᴅ ᴛʜᴇ ғᴏʀᴡᴀʀᴅ-ᴄᴏɴғɪɢ ᴄᴏᴍᴍᴀɴᴅs (<code>/setsource</code>, <code>/setdest</code>, <code>/clearsettings</code>, <code>/logout</code>) ʜᴀᴠᴇ ʙᴇᴇɴ ʀᴇᴍᴏᴠᴇᴅ. ᴜsᴇ <code>/settings</code> ɪɴsᴛᴇᴀᴅ.</b>

### ᴀᴜᴛᴏ ᴀᴄᴄᴇᴘᴛ

| ᴄᴏᴍᴍᴀɴᴅ | ᴡʜᴏ | ᴅᴇsᴄʀɪᴘᴛɪᴏɴ |
| --- | --- | --- |
| <code>/approve &lt;chat&gt;</code> | <b>ʟᴏɢɢᴇᴅ-ɪɴ ᴜsᴇʀ</b> | <b>ᴀᴘᴘʀᴏᴠᴇ ᴀʟʟ ᴘᴇɴᴅɪɴɢ ᴊᴏɪɴ ʀᴇǫᴜᴇsᴛs ɪɴ ᴀ ᴄʜᴀɴɴᴇʟ ᴜsɪɴɢ ʏᴏᴜʀ sᴇssɪᴏɴ — ᴘᴇʀ-ᴜsᴇʀ ʟᴏᴏᴘ (ᴀᴠᴏɪᴅs -503), sᴀᴠᴇs ᴇᴀᴄʜ ᴜsᴇʀ ᴛᴏ ᴅʙ. ʀᴇᴘᴏʀᴛs ᴀᴘᴘʀᴏᴠᴇᴅ / ғᴀɪʟᴇᴅ ʟɪᴠᴇ.</b> |
...
| <code>/settings</code> | <b>ᴀɴʏᴏɴᴇ</b> | <b>ᴏᴘᴇɴ ᴛʜᴇ ɢᴜɪ ᴘᴀɴᴇʟ — sᴏᴜʀᴄᴇ, ᴅᴇsᴛɪɴᴀᴛɪᴏɴ, ᴄʟᴇᴀʀ, ʟᴏɢᴏᴜᴛ, ᴀʟʟ ᴘʀᴏᴍᴏ ᴀᴄᴛɪᴏɴs</b> |
...
<b>ᴀʟʟ ᴀᴜᴛᴏ-ᴘʀᴏᴍᴏ ᴀᴄᴛɪᴏɴs ᴀʀᴇ ɪɴ ᴛʜᴇ <code>/settings</code> ᴘᴀɴᴇʟ:</b>

| ʙᴜᴛᴛᴏɴ | ᴡʜᴀᴛ ɪᴛ ᴅᴏᴇs |
| --- | --- |
| <b>➕ ɴᴇᴡ ᴘʀᴏᴍᴏ</b> | <b>2-sᴛᴇᴘ ᴡɪᴢᴀʀᴅ — ᴛᴀʀɢᴇᴛ ᴄʜᴀᴛ → ᴘʀᴏᴍᴏ ᴄᴏɴᴛᴇɴᴛ. ᴠᴀʟɪᴅᴀᴛᴇs ʙᴏᴛ ᴀᴅᴍɪɴ + <i>ʏᴏᴜʀ</i> ᴀᴅᴍɪɴ + 5-ᴘʀᴏᴍᴏ ʟɪᴍɪᴛ.</b> |
| <b>📋 ᴍʏ ᴘʀᴏᴍᴏs</b> | <b>ʟɪsᴛ <i>ʏᴏᴜʀ</i> ᴘʀᴏᴍᴏs (ɪᴅ, ᴛᴀʀɢᴇᴛ, ɪɴᴛᴇʀᴠᴀʟ, ᴏɴ/ᴏғғ).</b> |
| <b>⏱ ᴛɪᴍᴇ</b> | <b>ᴄʜᴀɴɢᴇ ᴛʜᴇ ɪɴᴛᴇʀᴠᴀʟ ғᴏʀ ᴀ ᴘʀᴏᴍᴏ (ʟᴏᴏᴘ ʀᴇsᴛᴀʀᴛs ᴄʟᴇᴀɴʟʏ).</b> |
| <b>▶ ᴘᴏsᴛ ɴᴏᴡ</b> | <b>ᴅᴇʟᴇᴛᴇ ᴘʀᴇᴠɪᴏᴜs + ᴘᴏsᴛ ɴᴏᴡ ᴡɪᴛʜᴏᴜᴛ ᴡᴀɪᴛɪɴɢ ғᴏʀ ᴛʜᴇ ɴᴇxᴛ ᴛɪᴄᴋ.</b> |
| <b>✏ ᴇᴅɪᴛ</b> | <b>ʀᴇᴘʟᴀᴄᴇ ᴘʀᴏᴍᴏ ᴄᴏɴᴛᴇɴᴛ — ᴋᴇᴇᴘs ᴛʜᴇ sᴀᴍᴇ ɪᴅ, ᴛᴀʀɢᴇᴛ ᴀɴᴅ ɪɴᴛᴇʀᴠᴀʟ.</b> |
| <b>👁 ᴘʀᴇᴠɪᴇᴡ</b> | <b>ᴄᴏᴘʏ ᴛʜᴇ sᴀᴠᴇᴅ ᴘʀᴏᴍᴏ ʙᴀᴄᴋ ɪɴᴛᴏ ʏᴏᴜʀ ᴅᴍ.</b> |
| <b>🟢/🔴 ᴏɴ/ᴏғғ</b> | <b>ᴇɴᴀʙʟᴇ ᴏʀ ᴘᴀᴜsᴇ ᴛʜᴇ ʟᴏᴏᴘ.</b> |
| <b>🗑 ᴅᴇʟᴇᴛᴇ</b> | <b>ᴅᴇʟᴇᴛᴇ ᴀ ᴘʀᴏᴍᴏ (ᴀʟsᴏ ᴄʟᴇᴀɴs ᴜᴘ ɪᴛs ʟᴀsᴛ ᴘᴏsᴛ).</b> |
| <b>📤 sᴇᴛ sᴏᴜʀᴄᴇ / 📥 sᴇᴛ ᴅᴇsᴛ</b> | <b>ᴄᴏɴғɪɢᴜʀᴇ ʏᴏᴜʀ ғᴏʀᴡᴀʀᴅ sᴏᴜʀᴄᴇ / ᴅᴇsᴛɪɴᴀᴛɪᴏɴ ᴄʜᴀɴɴᴇʟs.</b> |
| <b>🧹 ᴄʟᴇᴀʀ ғᴡᴅ</b> | <b>ᴄʟᴇᴀʀ ʏᴏᴜʀ sᴏᴜʀᴄᴇ & ᴅᴇsᴛɪɴᴀᴛɪᴏɴ.</b> |
| <b>🚪 ʟᴏɢᴏᴜᴛ</b> | <b>ʀᴇᴍᴏᴠᴇ ʏᴏᴜʀ sᴀᴠᴇᴅ sᴇssɪᴏɴ.</b> |

> <b>ᴇᴀᴄʜ ᴜsᴇʀ ᴄᴀɴ ᴏɴʟʏ sᴇᴇ / ᴇᴅɪᴛ / ᴅᴇʟᴇᴛᴇ ᴛʜᴇɪʀ ᴏᴡɴ ᴘʀᴏᴍᴏs. 5-ᴘʀᴏᴍᴏ ʟɪᴍɪᴛ ᴀᴘᴘʟɪᴇs ᴛᴏ ᴀʟʟ ɴᴏɴ-ᴏᴡɴᴇʀ ᴜsᴇʀs.</b>
...
6. <b>ᴛᴏ ʟᴏɢ ᴏᴜᴛ — ᴏᴘᴇɴ <code>/settings</code> ᴀɴᴅ ᴛᴀᴘ <b>🚪 ʟᴏɢᴏᴜᴛ</b>.</b>
...
3. <b>ɪɴ ʙᴏᴛ ᴅᴍ, ᴏᴘᴇɴ <code>/settings</code> ᴀɴᴅ ᴛᴀᴘ <code>➕ ɴᴇᴡ ᴘʀᴏᴍᴏ</code>.</b>
4. <b>ʙᴏᴛ ᴀsᴋs ғᴏʀ ᴛʜᴇ ᴛᴀʀɢᴇᴛ ᴄʜᴀᴛ — sᴇɴᴅ ᴛʜᴇ ɪᴅ (ᴇ.ɢ.</b> <code>-1001234567890</code><b>) ᴏʀ <code>@username</code>.</b>
5. <b>ɴᴇxᴛ ɪᴛ ᴀsᴋs ғᴏʀ ᴛʜᴇ ᴘʀᴏᴍᴏ ᴄᴏɴᴛᴇɴᴛ — sᴇɴᴅ ᴀɴʏᴛʜɪɴɢ:</b>
   - <b>ᴘʟᴀɪɴ ᴛᴇxᴛ ᴡɪᴛʜ ʟɪɴᴋs / ʙᴏʟᴅ / ɪᴛᴀʟɪᴄ ᴇᴛᴄ.</b>
   - <b>ᴘʜᴏᴛᴏ + ᴄᴀᴘᴛɪᴏɴ</b>
   - <b>ᴠɪᴅᴇᴏ + ᴄᴀᴘᴛɪᴏɴ</b>
   - <b>ᴀᴜᴅɪᴏ / ᴠᴏɪᴄᴇ / ᴀɴɪᴍᴀᴛɪᴏɴ / sᴛɪᴄᴋᴇʀ / ᴅᴏᴄᴜᴍᴇɴᴛ — ᴀʟᴏɴᴇ ᴏʀ ᴡɪᴛʜ ᴄᴀᴘᴛɪᴏɴ</b>
6. <b>ʙᴏᴛ ᴄᴏɴғɪʀᴍs ᴀɴᴅ ᴏᴘᴇɴs ᴛʜᴇ ᴘʀᴏᴍᴏ ᴅᴇᴛᴀɪʟ sᴄʀᴇᴇɴ. ɪɴᴛᴇʀᴠᴀʟ ᴅᴇғᴀᴜʟᴛs ᴛᴏ <code>20</code> ᴍɪɴᴜᴛᴇs ᴀɴᴅ ᴛʜᴇ ʟᴏᴏᴘ ɪs ᴇɴᴀʙʟᴇᴅ ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ.</b>
7. <b>ᴜsᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴs (<b>⏱ ᴛɪᴍᴇ</b>, <b>▶ ᴘᴏsᴛ ɴᴏᴡ</b>, <b>✏ ᴇᴅɪᴛ</b>, <b>🟢/🔴 ᴏɴ/ᴏғғ</b>, <b>🗑 ᴅᴇʟᴇᴛᴇ</b>) ᴛᴏ ᴍᴀɴᴀɢᴇ ᴛʜᴇ ᴘʀᴏᴍᴏ.</b>
...
- <b>ᴀʟʟ ᴘʀᴏᴍᴏ ᴄᴏᴍᴍᴀɴᴅs ᴀɴᴅ ғᴏʀᴡᴀʀᴅ-ᴄᴏɴғɪɢ ᴄᴏᴍᴍᴀɴᴅs ʀᴇᴍᴏᴠᴇᴅ</b> — <b>ᴇᴠᴇʀʏᴛʜɪɴɢ ɴᴏᴡ ɢᴏᴇs ᴛʜʀᴏᴜɢʜ ᴛʜᴇ <code>/settings</code> ʙᴜᴛᴛᴏɴ ᴘᴀɴᴇʟ. ᴅʀᴏᴘᴘᴇᴅ: <code>/setp</code>, <code>/list</code>, <code>/listp</code>, <code>/ptime</code>, <code>/promoon</code>, <code>/promooff</code>, <code>/promonow</code>, <code>/editpromo</code>, <code>/promopreview</code>, <code>/promostatus</code>, <code>/delpromo</code>, <code>/cancelp</code>, <code>/setsource</code>, <code>/setdest</code>, <code>/clearsettings</code>, <code>/logout</code>. <code>promo.py</code> ɪs ɴᴏᴡ ᴀ ᴘᴜʀᴇ ʟɪʙʀᴀʀʏ — ʜᴇʟᴘᴇʀs + sᴄʜᴇᴅᴜʟᴇʀ ᴏɴʟʏ.</b>
...
- <b><code>/approve</code> ɴᴏ ʟᴏɴɢᴇʀ ᴀᴜᴛᴏ-ᴅᴇᴄʟɪɴᴇs ғᴀɪʟᴇᴅ ᴀᴄᴄᴏᴜɴᴛs</b> — <b>ғᴀɪʟᴇᴅ ᴀᴘᴘʀᴏᴠᴀʟs ᴀʀᴇ ɴᴏᴡ ᴊᴜsᴛ ʀᴇᴘᴏʀᴛᴇᴅ ɪɴ ᴛʜᴇ ʟɪᴠᴇ sᴛᴀᴛᴜs sᴏ ᴀᴅᴍɪɴs ᴄᴀɴ ᴅᴇᴄɪᴅᴇ ᴡʜᴀᴛ ᴛᴏ ᴅᴏ.</b>
- <b>ᴘʀᴏᴍᴏ ᴄᴏɴᴛᴇɴᴛ ɪs sɴᴀᴘsʜᴏᴛᴛᴇᴅ</b> — <b>ᴛʜᴇ <code>/settings</code> ɢᴜɪ ᴄᴀᴄʜᴇs ᴛʜᴇ ᴘʀᴏᴍᴏ ᴍᴇssᴀɢᴇ (ᴛᴇxᴛ ᴀs ʜᴛᴍʟ, ᴍᴇᴅɪᴀ ᴀs <code>file_id</code> + ᴄᴀᴘᴛɪᴏɴ) ɪɴᴛᴏ ᴍᴏɴɢᴏᴅʙ. <i>ᴘᴏsᴛ ɴᴏᴡ</i> ᴀɴᴅ ᴛʜᴇ ᴀᴜᴛᴏ-ʟᴏᴏᴘ ᴋᴇᴇᴘ ᴡᴏʀᴋɪɴɢ ᴇᴠᴇɴ ᴀғᴛᴇʀ ᴛʜᴇ ᴏʀɪɢɪɴᴀʟ ᴅᴍ ᴍᴇssᴀɢᴇ ɪs ᴅᴇʟᴇᴛᴇᴅ.</b>
